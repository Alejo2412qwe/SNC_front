export const entorno = {
  ...
  /* urlApi: 'https://dsbackend.tecazuay.edu.ec/snc/api',
   ...
   urlPrivada: 'https://dsbackend.tecazuay.edu.ec/snc'*/

  /* urlApi: 'https://apps.tecazuay.edu.ec:9090/snc/api',
   urlPublica: 'https://apps.tecazuay.edu.ec:9090/snc/auth',
   urlPrivada: 'https://apps.tecazuay.edu.ec:9090/snc'*/
};
